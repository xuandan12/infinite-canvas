...
当前 Docker 镜像内置官方 Ark Seedance 2.0 的受限同源代理，同时支持标准 `https://ark.cn-beijing.volces.com/api/v3` 与 Agent Plan `https://ark.cn-beijing.volces.com/api/plan/v3`。创建与查询视频任务不会再由浏览器跨域直连 Ark。
